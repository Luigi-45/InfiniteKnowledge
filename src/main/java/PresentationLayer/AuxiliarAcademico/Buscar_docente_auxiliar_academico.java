 ...
 */
public class Buscar_docente_auxiliar_academico extends javax.swing.JFrame {
    ...
    public Buscar_docente_auxiliar_academico() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("BUSCAR DOCENTE");
   ...
   private void vaciarTabla(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscar_docente_auxiliar_academico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buscar_docente_auxiliar_academico().setVisible(true);
            }
        });
    }
