...
public class Formulario_auxiliar extends javax.swing.JFrame {


    public Formulario_auxiliar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtxtDNIDirectorAcademico = new javax.swing.JTextField();
        ...
        jLabel1.setText("Registrar Auxiliar Academico");
        ...
        jLabel5.setText("DNI del Auxiliar Académico :");
        ...
        jLabel14.setText("DNI de Director Académico :");

        jtxtDNIDirectorAcademico.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtDNIDirectorAcademicoKeyTyped(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jtxtDNIDirectorAcademico, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
                    .addComponent(jtxtDNIDirectorAcademico, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
                    .addComponent(jpContrasenia, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(jpContraseniaR, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(19, 19, 19)
                .addComponent(jButton1)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            if(this.jtxtDNIDirectorAcademico.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Error, ingrese el DNI del Director Académico");
            }
            else if(this.jtxtDNIDirectorAcademico.getText().length()!=8){
            ...
            else if(directorAcademicoBO.buscarPorDNI(this.jtxtDNIDirectorAcademico.getText())==null){
                JOptionPane.showMessageDialog(null, "Error, el DNI del Director Académico ingresado no existe");
            }
                ...
                JOptionPane.showMessageDialog(null, "Error, ingrese la contraseña del Auxiliar Académico");
            }
            else if(this.jpContraseniaR.getText().length()==0){
                JOptionPane.showMessageDialog(null, "Error, ingrese la verificación de la contraseña del Auxiliar Académico");
            }
                ...
                this.jcaFechaNacimiento.getDate(),this.jtxtNumeroTelefonico.getText(),(String) this.jcbGenero.getSelectedItem(),String.valueOf(usuarioBO.contarUsuariosRol(3)), (String) this.jcbGradoAcademico.getSelectedItem());
            
                Usuario usuario = new Usuario(0,this.jtxtDNI.getText(),this.jtxtCorreoElectronico.getText(),this.jpContrasenia.getText(),"2");
    ...
    private void jtxtDNIDirectorAcademicoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtDNIDirectorAcademicoKeyTyped
        char caracter = evt.getKeyChar(); 
        if(((caracter<'0')||(caracter>'9')) && ((caracter!='\b') || (caracter!='\t'))){
            evt.consume();
        }
        if(this.jtxtDNIDirectorAcademico.getText().length()==8) evt.consume();
    }//GEN-LAST:event_jtxtDNIDirectorAcademicoKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Formulario_auxiliar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField jtxtDNIDirectorAcademico;
